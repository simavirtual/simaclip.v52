...
**************************************************************************
* TITULO..: IMPRESION DE LAS AUSENCIAS POR ESTUDIANTES                   *
**************************************************************************

AUTOR: Nelson Fern ndez G¢mez       FECHA DE CREACION: JUL 31/2007 MAR A
       Colombia, Bucaramanga        INICIO: 11:30 AM   JUL 31/2007 MAR
...
FUNCTION Asist_404(lShared,nModCry,cNomSis,cEmpPal,cNitEmp,;
...
*>>>>GESTION DOCUMENTAL DEL INFORME
     ...
     *ÀN£mero de identificaci¢n del informe
       ...
       cOpcSys := '<INFORMES><AUSENCIAS ESTUDIANTE>'
     ...
     *ÀCampos a sustituir
       ...
       aTitIso := {}
       AADD(aTitIso,'RESUMEN DE AUSENCIAS POR ESTDUDIANTE')  // T¡tulo Uno
...
*>>>>RECORRIDO DE LOS REGISTROS
	  ...
	  AusEstDia(lShared,cNomSis,cNomEmp,cAnoUsr,cMaeAct,cJorTxt,;
		    PathPrn,FilePrn,nOpcPrn,cCodIso,aTitIso,aPieIso,;
		    dFecIni,dFecFin,@nHanXml,nRegFin)
...
/*************************************************************************
* TITULO..: AUSENCIAS POR ESTUDIANTE                                     *
**************************************************************************
...
FUNCTION AusEstDia(lShared,cNomSis,cNomEmp,cAnoUsr,cMaeAct,cJorTxt,;
		   PathPrn,FilePrn,nOpcPrn,cCodIso,aTitIso,aPieIso,;
		   dFecIni,dFecFin,nHanXml,nRegFin)
...
*==============IMPRESION DEL REGISTRO
		 ...
		 AADD(aRegPrn,ASI->cCodigoHra)
		 AADD(aRegPrn,&cMaeAct->cCodigoEst)
		 AADD(aRegPrn,cNombreTes)
		 AADD(aRegPrn,ASI->cObservCtr)
